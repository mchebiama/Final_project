        ...
        <div class="row">
            <div class="col-md-12" >
                <form action="" name="admin_page" class="form-control" method="post" id="form">
                    ...
                    <button class="btn btn-primary" type="submit" name="admin_page">Register</button>
                    <br>
...
<div class=" container-fluid row footer bg-black text-white" >
    ...
    if (isset($_POST["admin_page"])){
        $admName=$_POST["adm_name"];
        $admEmail=$_POST["adm_email"];
        $admPass=$_POST["adm_pass"];

        require_once "db_connection.php";
//        $Query=mysqli_select_db($connection, "inventory");
        $insertQuery= "INSERT INTO `admin`(`id`, `name`, `email`, `pass`)
                        VALUES (null,'$admName','$admEmail','$admPass')";
